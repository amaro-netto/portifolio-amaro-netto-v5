      ...
      <div className="container mx-auto px-4 h-full flex items-center">
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-start animate-in slide-in-from-bottom-5 fade-in duration-700 w-full">
          ...
          <div className="lg:w-2/3 relative clearfix">
            ...
            {/* IMAGEM ÚNICA (Sem variação de modo escuro) */}
            <img
              src={sobre}
              alt="Foto de Amaro Netto"
              className={`hidden lg:block ${sharedImageStyles} ${imageHeightClass} [shape-outside:url('/src/assets/sobre.webp')]`}
              loading="lazy"
            />
          ...
          <div className="lg:w-1/3 flex flex-col justify-center items-center text-center p-10 bg-secondary/10 rounded-3xl border border-border/50 hover:border-primary/20 transition-all duration-500 shadow-lg hover:shadow-xl sticky top-32 z-0">
            <div className="mb-8 p-6 bg-primary/10 rounded-full">
              {/* Removido o filtro dark:invert para respeitar o tema único */}
              <img
                src={logoLight}
